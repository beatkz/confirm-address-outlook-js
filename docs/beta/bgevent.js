...
var isDisplayDialogSupported; // Dialog APIサポート判定用のグローバル変数

Office.onReady(function (info) {
  console.log("bgevent.js: Office.js 初期化完了:", JSON.stringify(info));
  isDialogApiSupported().then(function (supported) {
...
function isDialogApiSupported() {
  return _isDialogApiSupported.apply(this, arguments);
} // HTMLタグを除去してプレーンテキストに変換する関数（改行を保持）
function _isDialogApiSupported() {
  _isDialogApiSupported = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
