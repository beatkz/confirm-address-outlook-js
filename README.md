...
To get started, upload [the Add-in only Manifest](manifest.xml) into [olksideload page](https://aka.ms/olksideload). More information, please see the [Microsoft Learn Page](https://learn.microsoft.com/en-us/office/dev/add-ins/outlook/sideload-outlook-add-ins-for-testing?tabs=xmlmanifest).
